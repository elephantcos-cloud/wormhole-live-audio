...
import 'package:iyox_wormhole/pages/audio_stream_page.dart';
...
final GlobalKey<NavigatorState> _shellAudioNavigatorKey =
    GlobalKey<NavigatorState>(debugLabel: 'audio');
  ...
  routes: [
    StatefulShellRoute.indexedStack(
      ...
      branches: [
        ...
        StatefulShellBranch(
          navigatorKey: _shellAudioNavigatorKey,
          routes: [
            GoRoute(
              path: '/audio',
              pageBuilder: (context, state) =>
                  MaterialPage(child: AudioStreamPage()),
            )
          ],
        ),
      ],
